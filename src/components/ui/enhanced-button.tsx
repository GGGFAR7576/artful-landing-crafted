  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-accent text-white font-semibold shadow-elegant hover:scale-105 hover:shadow-button border-0",
        forest: "bg-forest text-forest-foreground hover:bg-forest/90 shadow-button",
        terracotta: "bg-terracotta text-terracotta-foreground hover:bg-terracotta/90 shadow-button",
      },
      size: {
